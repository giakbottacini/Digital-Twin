function [u, FE_SPACE, MESH, DATA_THERMO] = Elliptic_SolverMatteo(dim, elements, vertices, boundaries, fem, data_file_temp, param, vtk_filename,i)
...
if ~isempty(vtk_filename)
    oldFolder = cd(['/Users/matteotorzoni/Desktop/Corigliano/PORTALE/Dati/',DATA_THERMO.problem,'/Temperatura/Temperature_',num2str(i)]);
