...
/* nlhs è il numero di termini che vengono dati in ingresso,
* riportati da plhs[].
* Idem per nrhs e prhs.
* Inizialmente vengono solo creati i collegamenti nella memoria
*/
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    int noe     = mxGetN(prhs[1]);  /*noe=number of elements*/
