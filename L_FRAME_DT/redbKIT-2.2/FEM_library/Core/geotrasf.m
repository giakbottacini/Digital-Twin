...
%delle funzioni di forma). Per qualche motivo invece di procedere
%iterativamente va a calcolare l'inverso del jacobiano per ogni elemento
%(questo potrebbe dare problemi di memoria)
...
switch dim
    ...
    case 2
        ...
        %L: calcola qual'è il lato di dimensione maggiore per ciascun
        %triangolo
